...
BONGOS_KEYBIND = "/bob keybind - Toggles hover-to-bind keybinding mode"

BONGOS_KEYBIND_HELP = "|cff33ffccBongos Keybind Mode|r\nHover a button and press a key, mouse button, or mouse wheel to bind it.\nHold Alt/Ctrl/Shift for modified keys.\nPress Escape on a button to clear its binding.\n\nPress Escape or click an empty area to leave keybind mode."
