...
pfSkin:RegisterSkin("Readycheck", "vanilla:tbc", function ()
  HookAddonOrVariable("Blizzard_RaidUI", function()
    ...
    frame.bar:SetStatusBarTexture(pfSkin.media["img:bar"])
    ...
    frame.bar.text:SetFont(pfSkin.font_default, 12, "OUTLINE")
