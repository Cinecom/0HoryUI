...
pfSkin:RegisterSkin("Friends", "vanilla:tbc", function ()
  local rawborder, border = GetBorderSize()
  local bpad = rawborder > 1 and border - GetPerfectPixel() or GetPerfectPixel()
  local maxtab = pfSkin.expansion == "vanilla" and 4 or 5
  ...
  do -- Who Tab
    ...
    for i = 1, WHOS_TO_DISPLAY do
      ...
      frame.classicon:SetTexture(pfSkin.media["img:classicons"])
