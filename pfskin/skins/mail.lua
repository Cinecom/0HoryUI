...
pfSkin:RegisterSkin("Mailbox", "vanilla:tbc", function ()
      ...
      hooksecurefunc("SendMailFrame_Update", function()
        for i = 1, ATTACHMENTS_MAX_SEND do
          ...
          if link then
            ...
            btn:SetBackdropBorderColor(GetStringColor(pfSkin_config.appearance.border.color))
          end
        end
      end)
        ...
        if not this._Mail then
          ...
          hooksecurefunc("SendMailFrame_Update", function()
            ...
            if link then
              ...
              SendMailPackageButton:SetBackdropBorderColor(GetStringColor(pfSkin_config.appearance.border.color))
            end
          end)
        end
      end)
        ...
        for i = 1, 21 do
          ...
          button.SetNormalTexture = function(self, tex)
            ...
            if button.item then
              ...
              self:SetBackdropBorderColor(GetStringColor(pfSkin_config.appearance.border.color))
            end
          end
        end
    ...
    do -- OpenMailFrame
      ...
      hooksecurefunc("InboxFrame_OnClick", function(index)
        ...
        if link then
          ...
          OpenMailPackageButton:SetBackdropBorderColor(GetStringColor(pfSkin_config.appearance.border.color))
        end
      end)
    end
  end
