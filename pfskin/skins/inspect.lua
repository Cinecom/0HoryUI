...
pfSkin:RegisterSkin("Inspect", "tbc", function ()
    ...
    do -- Character Tab
      ...
      hooksecurefunc("InspectPaperDollItemSlotButton_Update", function(button)
        ...
        if link then
          ...
          button:SetBackdropBorderColor(pfSkin.cache.er, pfSkin.cache.eg, pfSkin.cache.eb, pfSkin.cache.ea)
        end
      end)
    end
...
pfSkin:RegisterSkin("Inspect", "vanilla", function ()
  local rawborder, border = GetBorderSize()
  local bpad = rawborder > 1 and border - GetPerfectPixel() or GetPerfectPixel()
  ...
  HookAddonOrVariable("Blizzard_InspectUI", function()
            ...
            if not quality then
              ...
              if ShaguScore then
                if not slot.scoreText then
                  ...
                  slot.scoreText:SetFont(pfSkin.font_default, 12, "OUTLINE")
    ...
    do -- Honor Tab
      ...
      InspectHonorFrameProgressBar:SetStatusBarTexture(pfSkin.media["img:bar"])
      ...
      if TWTalentFrame then
        ...
        for i = 1, (MAX_NUM_TALENTS or 100) do
          ...
          if talent then
            ...
            if rank then
              rank:SetFont(pfSkin.font_default, C.global.font_size, "OUTLINE")
            end
          end
        end
