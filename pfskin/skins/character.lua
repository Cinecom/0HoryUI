...
pfSkin:RegisterSkin("Character", "vanilla:tbc", function ()
  ...
  if PlayerTitleDropDown then -- tbc, wotlk
    ...
    HonorFrameProgressBar:SetStatusBarTexture(pfSkin.media["img:bar"])
  ...
  do -- Character Tab
      ...
      if slot and slot.backdrop then
        if link then
          ...
          elseif quality and quality > 0 then
            ...
            slot.backdrop:SetBackdropBorderColor(pfSkin.cache.er, pfSkin.cache.eg, pfSkin.cache.eb, pfSkin.cache.ea)
          end
        else
          slot.backdrop:SetBackdropBorderColor(pfSkin.cache.er, pfSkin.cache.eg, pfSkin.cache.eb, pfSkin.cache.ea)
        end
    ...
    for _, slotName in pairs(slots) do
      ...
      if not frame.scoreText then
        ...
        frame.scoreText:SetFont(pfSkin.font_default, 12, "OUTLINE")
  ...
  do -- Pet Tab
    ...
    PetPaperDollFrameExpBar:SetStatusBarTexture(pfSkin.media["img:bar"])
  ...
  do -- Reputation Tab
    ...
    for i = 1, NUM_FACTIONS_DISPLAYED do
      ...
      StripTextures(bar)
      CreateBackdrop(bar)
      bar:SetStatusBarTexture(pfSkin.media["img:bar"])
  ...
  do -- Skills Tab
    ...
    for i = 1, SKILLS_TO_DISPLAY do
      ...
      frame:SetStatusBarTexture(pfSkin.media["img:bar"])
      frame:SetHeight(12)
    end
    ...
    SkillDetailStatusBar:SetStatusBarTexture(pfSkin.media["img:bar"])
