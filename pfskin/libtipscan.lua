...
--[[ libtipscan ]]--
-- A pfSkin library that provides tooltip scanner.
--
...
if pfSkin.api.libtipscan then return end

local libtipscan = {}
local baseName = "pfSkinScan"
local methods = {
...
-- add libtipscan to pfSkin API
pfSkin.api.libtipscan = libtipscan
