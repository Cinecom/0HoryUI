...
--[[ libunitscan ]]--
-- A pfSkin library that detects and saves all kind of unit related informations.
...
-- persisted within the pfSkin_playerDB where the mob data is a throw-away table.
...
if pfSkin.api.libunitscan then return end
...
libunitscan:SetScript("OnEvent", function()
  if event == "PLAYER_ENTERING_WORLD" then
    ...
    -- load pfSkin_playerDB
    units.players = pfSkin_playerDB
...
pfSkin.api.libunitscan = libunitscan
